...
@Controller
public class OtherReaderInformationControl {
    @Autowired
    private ReaderService readerService;
    @Autowired
    private BookService bookService;

    @RequestMapping("/otherReaderInformation.action")
    public void getOtherReaderInformation(Integer readerId, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/JSP/userinformation1.jsp").forward(request, response);
    }
}
