...
<script>	
    ...
    */
    $(function loginCheck(){//判断用户名是否存在
        $.ajax({
            type: "post",
            url: "<%=basePath%>Writer/login.action?name="+name,
            //  data: "tel="+tel,
  ...
  window.onload=function(){
    ...
    $(function checkRegisterName() {
        $("#register-username").keyup(function() {
            ...
            $.ajax({
                type: "post",
                url: "<%=basePath%>Writer/loginCheck.action?name="+name,
                //  data: "tel="+tel,
                success: function (Info) {
                    if (Info == true) {
                        flag2=false;
    ...
    $(function checkRegisterTel() {
        $("#register-code").keyup(function() {
            ...
            $.ajax({
                type: "post",
                url: "<%=basePath%>Writer/registerCheckTel.action?tel="+tel,
                //  data: "tel="+tel,
                success: function (Info) {
                    if (Info == false) {
...
body{
	...
	background-image: url(<%=basePath%>Images/writeLogin2.jpg);
...
<body>
	<c:set var="mycookie" value="${cookie.writerloginInfo.value }"></c:set>
	...
	<div id="login">
		...
		<div class="wrapper" style="margin-top: 30px;">
			...
			<div class="login sign-in-htm">
				<form action="<%=basePath%>Writer/login.action" class="container offset1 loginform" method="post" >
					<!-- 猫头鹰控件 -->
						...
						<section class="content">
								     ...
								     <c:choose>
										 ...
										 <c:when test="${not empty mycookie}">
											 <input class="input__field input__field--hideo" type="text" id="login-username"
													value="${rem[0]}" name="writerNeckName" autocomplete="off" placeholder="请输入用户名" tabindex="1" maxlength="15" />

										 </c:when>
										 <c:otherwise>
											 <input class="input__field input__field--hideo" type="text" id="login-username"
													value="${requestScope.uname}" name="writerNeckName" autocomplete="off" placeholder="请输入用户名" tabindex="1" maxlength="15" />
										 </c:otherwise>
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password"
									   value="${rem[1]}"  name="writerPassword" id="login-password" placeholder="请输入密码" tabindex="2" maxlength="15"/>
			...
			<div class="login sign-out-htm">
				<form action="<%=basePath%>Writer/findPass.action" method="post" class="container offset1 loginform">
					...
					<div class="pad input-container">
						<section class="content">
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="code" id="code forget-code" name="code" autocomplete="off" placeholder="请输入验证码"/>
							...
							<span> <input class="btn btn-default" id="btn" name="btn" value="发送验证码" onclick="sendMessage()" /></span>
							<span class="input input--hideo">
			...
			<div class="login sign-up-htm">
				<form action="<%=basePath%>Writer/register.action" method="post" id="regForm" class="container offset1 loginform">
					<!-- 猫头鹰控件 -->
						...
						<section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-username" 
									name="writerNeckName" autocomplete="off" placeholder="请输入用户名" maxlength="15"/>
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password" id="register-password"
									   name="writerPassword" placeholder="请输入密码" maxlength="15"/>
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password" name="writerRePassword"
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-code"
									   name="writerTel" autocomplete="off" placeholder="请输入手机号"/>
	...
	<script type="text/javascript">
        ...
        $("[name='code']").blur(function(){
            ...
            {
                $.ajax({
                    url:"<%=basePath%>Writer/checkIdentifyCode.action?code="+code,
                    type:"post",
                    data:{"phone":phone},
