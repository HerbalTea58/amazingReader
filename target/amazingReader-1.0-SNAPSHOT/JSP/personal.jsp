    ...
    <div class="qdp-content home-content" data-l1="3" >
        <div class="home-user-wrapper qdp-border" data-l2="1" style="background-image:url(../Images/home-index-bg.0.2.png)">
            <div class="home-user-avatar" data-l3="1">
                <a href="<%=basePath%>reader/userinformation.action?readerId=${reader.readerId}" class="user-avatar-a"><img class="user-avatar-img" src="../${reader.readerPortrait}" alt="${reader.readerNeckName}的头像" data-eid="qd_M24"></a>
                <span class="header-avatar-vip author-darkblue">${statu.statuName}</span>
            </div>
            <div class="home-user" data-l3="1">
                <h3><a href="<%=basePath%>reader/userinformation.action?readerId=${reader.readerId}" data-eid="qd_M25">${reader.readerNeckName}</a><a href="<%=basePath%>score/personalscore.action"  class="home-user-level" data-eid="qd_M26">Lv${readerLevel}</a></h3>
                <div class="home-user-safety" style="margin-top: 30px">
                    <a href="javascript;;" target="_blank"></a>
            </div>
        </div>
        <ul class="qdp-border home-msg-wrapper" data-l2="1" style="margin-top: 50px">
            <li class="home-msg" data-l3="1" style="width:258px;margin-left: 0px;margin-top: 10px" >
                <div class="home-msg-title"><i class="iconfont icon-price yellow"></i><b>账户余额</b></div>
                <div class="home-msg-data"><a href="<%=basePath%>reader/readermoney.action" data-eid="qd_M30"><b class="home-msg-b">${reader.readerBalance}</b>惊鸿币</a></div>
                <a class="home-msg-more blue elPayBtn" href="<%=basePath%>recharge/recharge.action" target="_blank" data-eid="qd_M30">充值</a>
            </li>
            <li class="home-msg" data-l3="2"  style="width:258px">
                <div class="home-msg-title"><i class="iconfont icon-piaojia green"></i><b>我的票夹</b></div>
                <div class="home-msg-data"><a href="<%=basePath%>/reader/readerRecommendTicketsRecord.action" data-eid="qd_M31"><b class="home-msg-b home-msg-num">${reader.readerRecommendTicket}</b>&nbsp;&nbsp;</span>推荐票</a></div>
                <a class="home-msg-more blue" href="<%=basePath%>/reader/readerRecommendTicketsRecord.action" class="blue" data-eid="qd_M31">立即查看</a>
            </li>
            <li class="home-msg" data-l3="2" style="width:256px">
                <div class="home-msg-title"><i class="iconfont icon-book blue"></i><b>我的书架</b></div>
                <div class="home-msg-data"><a href="<%=basePath%>bookshelf/searchbookshelf.action" data-eid="qd_M32"><b class="home-msg-b">${readerBookRelation}</b>本藏书</a></div>
                <a class="home-msg-more blue" href="<%=basePath%>bookshelf/searchbookshelf.action" class="blue" data-eid="qd_M32">立即查看</a>
            </li>
        </ul>
        <form id="addToShelfForm" action="" class="shelf-recmd qdp-border" method="post" data-l2="1">
            ...
            <c:forEach items="${bookList1}" var="book" begin="0" end="5">
                <li class="recmd-list-item">
                    ...
                    <div class="recmd-list-data" title="猜你喜欢">猜你喜欢</div>
                </li>
            </c:forEach>
            </ul>
        </form>
