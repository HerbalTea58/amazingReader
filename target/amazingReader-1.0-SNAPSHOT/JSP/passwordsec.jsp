...
<head>
    ...
    <title>身份验证_阅文安全_阅文集团</title>
     ...
     <link rel="stylesheet" type="text/css" href="../Csscss/reset1.css"/>
...
<div class="step-tips">
    <div class="box-center">
        ...
        <span><i>2</i><em>设置密保问题</em></span>
        <span><i>3</i><em>确认密保问题</em></span>
         <span><i>4</i><em>确设置成功</em></span>
            </div>
</div>
<!-- end 步骤进度提示 -->
    ...
    <div class="footer">
        <div class="box-center">
            <div class="friend-link">
                <a href="https://www.yuewen.com" target="__blank">关于阅文</a><em>|</em>
