                    ...
                    <div style="float: left; margin-left: 50px; margin-top: 130px">
                        <table cellpadding="0" cellspacing="0" style="float:left;margin-top: 50px;border: #dddddd 1px solid;">
                            ...
                            <c:if test="${not empty AllOrder}">
                                ...
                                <div id="pagetest7" style="position: absolute; top:233px;font-size: 15px; border: none"></div>
                            </c:if>
                        </table>
                    </div>
            </div>
...
<script type="text/javascript">
    document.getElementById("find1").onclick = function () {
            document.findform.action = "${pageContext.request.contextPath}/Writer/WriterRewardIncomeDetail1.action";
            document.findform.submit();
    }
    document.getElementById("find2").onclick = function () {
        document.findform.action = "${pageContext.request.contextPath}/Writer/WriterRewardIncomeDetail2.action";
        document.findform.submit();
    }
</script>
<script type="text/javascript">
