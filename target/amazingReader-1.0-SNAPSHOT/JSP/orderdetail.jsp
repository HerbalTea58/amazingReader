...
<body class="finance">
                ...
                <div class="header-wrapper">
                    ...
                    <ul class="header-nav">
                        ...
                        <li class="header-nav-li" id="headerNav">
                            <a href="<%= basePath%>readercomment/Readercomments.action" class="header-nav-a " accesskey="2" data-eid="qd_M02"><i class=""></i>我的书架</a>
                        </li>
        ...
        <div class="qdp-wrapper">
               <div class="personal-sideBar" data-l1="2">
                   ...
                   <ul class="sideBar-group">
                       <li>
                           <a href="<%=basePath%>reader/readermoney.act
                   </ul>
                   <ul class="sideBar-group">
                       <li>
            ...
            <div class="qdp-content" data-l1="3">
                ...
                <div class="finance-record qdp-record" >
                    <div id="tabView" class="ui-tab-tabs" data-l2="2">
                        <a href="javascript:;" class="checked" data-rel="tabTarget1" data-eid="qd_M45">详细记录</a>
                    </div>
                            ...
                            <div id="tableTarget1" class="table-x piaojia-month-table">
                                <div class="table-size">
                                    <table class="ui-table" id="shelfTable">
                                        <tr>
                                            <th scope="col" width="90">购买章节名</th>
                                        </tr>
                                        <c:forEach items="${chapterList}" var="chapterList">
                                            <tr class="checktr">
                                                <td id="all">
                                                    <a href="<%=basePath%>reader/readChapter.action?chapterId=${chapterList.chapterId}" >  ${chapterList.chapterName}</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </table>

                                </div>ion" class="sideBar-list-a" target="_blank" data-eid="qd_M20"><i class=""></i>交易记录</a>
                       </li>
