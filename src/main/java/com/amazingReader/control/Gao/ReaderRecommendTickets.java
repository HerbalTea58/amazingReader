...
@Controller
public class ReaderRecommendTickets {
    @Autowired
    private ReaderService readerService;
    @RequestMapping("/readerCommendTickets.action")
    public void getRecommendTickets(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
