...
<div class="qdp-wrapper">
    <div class="personal-sideBar" data-l1="2">
        <ul class="sideBar-group">
            ...
            <li class="">
                <a href="<%= basePath%>readercomment/Readercomments.action" class="sideBar-list-a" data-eid="qd_M13"><i class=" "></i>我的票夹</a>
            </li>
    ...
    <div class="qdp-content" data-l1="3" >
        <h2 class="qdp-hometitle"><a href="javascript;;"></a>&nbsp;&nbsp;用户
            <span style="color: red;font-size: 15px">${reader.readerNeckName} &nbsp;</span>个人信息</h2>
        <div class="qdp-record setting-record" data-l2="9">
            <div id="tabView" class="ui-tab-tabs">
                <a href="javascript:;" id="tabTarget1" class="checked" data-eid="qd_M134">基本信息</a>
                <a href="javascript:;" class="" id="tabTarget2" data-eid="qd_M135">头像</a>
            </div>
            <div id="jsTabContents" class="ui-tab-contents" >
                <div id="tab1" class="ui-tab-content checked" data-l3="24">
                    ...
                    <div id="tab2" class="ui-tab-contents" style="height: 500px">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <img src="<%=basePath%>${reader.readerPortrait}" class="img2" onclick="hide()" style="width: 400px;height: 400px;margin-top: -320px;padding-left: 195px;display: none"/>
                    </div>
            </div>
        </div>
    </div>
